                  ...
                  <div className="flex-column flex-md-row d-flex align-items-start gap-15">
                    ...
                    <div>
                      ...
                      >
                        ...
                        documents, background checks, and certifications
                        required by potential employers. Keep your documents
                        up-to-date to ensure seamless job applications and avoid
            ...
            {stats.nonCompliant > 0 && (
              <div className="alert alert-danger d-flex align-items-start gap-10 mb-15">
                ...
                <div>
                  ...
                  {stats.nonCompliant} rejected document(s). Please resubmit to
